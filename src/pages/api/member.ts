...
export default function handler(
  ...
  const data = [
    ...
    },
    {
      ...
      member_regular: false,
      username_idn: "Shasa JKT48",
      username_ig: "jkt48.shasa",
      username_sr: "Shasa / シャサ (JKT48)",
