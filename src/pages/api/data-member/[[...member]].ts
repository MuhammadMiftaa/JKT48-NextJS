...
export default async function handler(
  ...
  if (req.query.member?.[0]) {
    if (req.query.member[0] === "add" && req.method === "POST") {
      ...
      if (member.universitas === "" || member.universitas === undefined)
        member.universitas = "-";
      if (member.jurusan === "" || member.jurusan === undefined)
        member.jurusan = "-";
      if (member.username_idn === "" || member.username_idn === undefined)
        member.username_idn = "-";
      if (member.username_ig === "" || member.username_ig === undefined)
        member.username_ig = "-";
      if (member.username_sr === "" || member.username_sr === undefined)
        member.username_sr = "-";
      if (member.username_tiktok === "" || member.username_tiktok === undefined)
        member.username_tiktok = "-";
      if (member.username_x === "" || member.username_x === undefined)
        member.username_x = "-";
