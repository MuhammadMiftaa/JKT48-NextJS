...
export default function UpdateMemberCell({ member }: { member: MemberTypeZod }) {
              ...
              >
                <div className="w-11/12 h-96 grid grid-cols-3 grid-rows-5">
                  ...
                  <div className="col-span-2 flex items-center gap-4 pl-3">
                    <label className="cursor-pointer w-1/4" htmlFor="regular">
                      <input
                    ...
                    <label className="cursor-pointer w-1/4" htmlFor="trainee">
                      <input
                        className="hidden peer"
                        type="radio"
                        id="trainee"
