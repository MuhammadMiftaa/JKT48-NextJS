  ...
  return (
    ...
    >
      <div className="w-full z-10">
        <h1 className="text-4xl md:text-6xl mb-2 font-bold text-custom-green font-poppins animate__animated animate__fadeInLeft  animate__delay-1s animate">
          JKT48
        </h1>
        <p className="text-[10px] md:w-[60%] md:mb-10 md:text-sm font-extralight text-slate-300 tracking-[.1px] font-poppins animate__animated animate__fadeInLeft animate__delay-1s animate__slow flex gap-3">
