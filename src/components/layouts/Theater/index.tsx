...
export default function Theater() {
  return (
    <>
      <h1 className="capitalize w-fit mx-auto font-poppins font-bold pt-28 mb-12 text-3xl bg-clip-text text-transparent bg-gradient-to-r from-custom-green to-blue-600 from-30%" data-aos="flip-left" data-aos-duration="800" id="theater">
        Upcoming Theater
      </h1>
      <div className="py-5 px-32 flex flex-col gap-y-12">
        <div className="flex gap-x-8 items-center font-urbanist" data-aos="zoom-in-up" data-aos-duration="1000">
