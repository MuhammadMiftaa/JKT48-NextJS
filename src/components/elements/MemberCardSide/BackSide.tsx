...
export default function BackSide(props: {
  ...
  return (
    <div
      className={`back rotate-y-180 backface-hidden border-${baseColor} border rounded-2xl  bg-gradient-to-br from-zinc-700 via-custom-black to-black flex flex-col justify-end items-center pb-2 absolute top-0 bottom-0 left-0 right-0 hover:cursor-pointer overflow-hidden shadow-xl shadow-${baseColor} duration-700`}
    >
      <div
